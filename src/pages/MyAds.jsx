...
import PullToRefresh from '@/components/shared/PullToRefresh'; // <-- IMPORTAÇÃO DO NOVO COMPONENTE
import { 
...
export default function MyAdsPage() {
  ...
  // Fetch My Ads - Extraímos o 'refetch' para usar no Pull-to-Refresh
  ...
  return (
    <PullToRefresh onRefresh={handleRefresh}> {/* <-- ENVOLVEMOS A PÁGINA AQUI */}
